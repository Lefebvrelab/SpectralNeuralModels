...
from autograd.numpy import pi,abs,exp,log,log10,log1p,isnan
...
class Abeysuriya2015Model():
    ...
    def fit(self,data,freqs,param_list,tol,normalize=False,fit_log=False):
        ...
        if fit_log: 
          EEG_fun = lambda P: log1p(self.update_and_compute_P(P, param_list,freqs,normalize=normalize))
        else:
        ...
        fit_result = optimize.minimize(chi_fun, P0, bounds=bounds_list, tol=tol,jac=chi_fun_jac)
